...
הכרטיסיות הן לפורמט שאלה-תשובה פתוחה, לא מבחן אמריקאי. אין צורך באפשרויות תשובה מרובות - רק שאלה ותשובה קצרה.`;
...
השתמש בחומר הלימוד המצורף כמקור בלעדי לידע. כל כרטיסייה צריכה להיות בפורמט שאלה-תשובה פתוחה (לא מבחן אמריקאי).
...
תשובות קצרות ותמציתיות (משפט אחד או שניים). אין להשתמש בעיצוב טקסט כלשהו (כמו הדגשה). כל התוכן חייב להיות בעברית.
