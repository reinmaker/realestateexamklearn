...
const LoginView: React.FC<LoginViewProps> = ({ onLogin }) => {
    ...
    return (
        <div className="flex min-h-screen bg-slate-100">
            {/* Login Form - Left Sidebar */}
            <div className="flex-shrink-0 w-full md:w-96 flex items-center justify-center p-4 md:p-6 bg-transparent">
                ...
                <div className="text-center mb-6">
                    <div className="flex flex-col items-center justify-center gap-2 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 512 512" className="flex-shrink-0">
                            <defs>
                                <style>
                                    {`.logo-stroke { stroke: #1e293b; fill: none; stroke-width: 22; stroke-linecap: round; stroke-linejoin: round; }
                        ...
                        <h1 className="text-2xl font-bold text-slate-800">RealMind</h1>
                    </div>
                    ...
                    {isSignUp && (
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 bg-white border border-slate-300 text-slate-800 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 placeholder:text-slate-400"
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-slate-100 text-slate-500">או</span>
                    </div>
                </div>
            ...
            <div className="hidden md:flex flex-1 bg-slate-800">
                <video 
